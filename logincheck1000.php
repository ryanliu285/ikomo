      ...
      <div class =  "container-fluid">
          <div class = "row">
              ...
              <div class = "col-md-10 signup">
                ...
                <h3>You are about to purchase 1000 KOMOcoins. This is enough to purchase ten iKOMO. Ensure that when buying KOMOcoins, you click the "return" button at the bottom after the checkout completes and that nothing else is in your virtual cart! <strong>If your KOMOcoins are not added PLEASE contact iKOMO support.</strong></h3>
                <!--TODO: Add image that shows what it looks like-->
                <a href = "https://portal.veinternational.org/buybuttons/us021804/btn/chest-of-komocoins1000-ik1000/"><button>Continue</button></a>
              </div>
              <div class = "col-md-1">
              </div>
              </div>
