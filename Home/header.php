...
<body>
  <header>
    ...
    <a class = "nav" href = "#">Contact Us</a>
      ...
      <div class = "col-md-5">
        <form class = "nav" action = "includes/login.inc.php" method = "post">
      ...
      <div class = "col-md-2">
          <a class = "navs"href = "signup.php">Signup!</a>
        <form class = "navl" action = "includes/logout.inc.php" method = "post">
