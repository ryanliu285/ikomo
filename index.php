          ...
          <div class = "row">
            ...
            <div class = "col-md-10">
              <center>
                ...
                <br>
                <img width = "50px" src = "./img/chickanim.gif"/> <a href = "about.php" class = "learnmore">  About Page</a>
                <br>
                <br>
                <img height = "50px" src = "./img/fb.png"/><a href = "https://www.facebook.com/IKOMO-VEI-999053610286250/" class = "learnmore">  Facebook</a>
                <br>
                <br>
                <img height = "50px" src = "./img/snap.png"/> <a href = "/img/snap.png" class = "learnmore">  Snapchat</a>
                <br>
                <br>
