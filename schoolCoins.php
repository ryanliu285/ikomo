      ...
      <div id = "tutorialText">
        <div class = "row">
          ...
          <div class = "col-md-9"class = "animated BounceInRight" id = "textBack" onclick = "next()">
            <p id = "1.1"><br>We can use virtual currency to purchase KOMO coins. Clicking on the button allows you to buy different amounts of KOMO coins which are used to buy iKOMO. (Click to continue!)</p>
            <p id = "2.1" class = "step"><br>Lets see what would happen if we clicked on a button! (Click to continue!)</p>
            <p id = "3.1" class = "step"><br>Click on the “Pouch of KOMOcoins (100)” Button.</p>
            <p id = "4.1" class = "step"><br>Please read the disclaimer! It is important that you click the "return" link on the VEI checkout completion screen, otherwise you will not receive any KOMOcoins! (Click to continue!)</p>
            <img id = "4.2" class = "step" src = "./img/returnExample.png">
          </div>
        </div>
      </div>
    </div>
  ...
  var current = 1;
    function next(){
      if(current == 2){
        ...
        var temp = document.getElementById("4.1");
      ...
      <div class = "row">
        ...
        <div id = "mainWelcomeText" class = "centerpls col-md-9">
          ...
          <img id = "TRUCKoverlay" src = "./img/truck.png"/>
            <a id = "yeet"><button class = "bigbt" id = "buyButton100">Pouch of KOMOcoins (100)<br>$25</button></a>
            <a><button class = "bigbt" id = "buyButton500">Sack of KOMOCoins (500)<br>$120</button></a>
            <a><button class = "bigbt" id = "buyButton1000">Chest of KOMOCoins (1000)<br>$230</button></a>
            <a><button class = "bigbt" id = "buyButton2000">Barrel of KOMOCoins (2000)<br>$450</button></a>
            <a><button class = "bigbt" id = "buyButton5000">Truck of KOMOCoins (5000)<br>$1200</button></a>
            <script>
